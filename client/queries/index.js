...
export const getEventById = id => graphql(`{ getEventById(id:${id}) { id name time address1 address2 city state zip country send_invitations notes } }`);
export const getAllEvents = () => graphql(`{ getAllEvents { id name time address1 address2 city state zip country send_invitations notes } }`);
